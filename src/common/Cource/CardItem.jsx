      ...
      <div className="relative w-full group">
        <div>
          <div className="mx-auto mb-5 w-full">
            <img
              className="border-2 bg-violet-300 mx-auto rounded-lg w-[310px] h-[175px] object-fill"
          ...
          <div className="flex flex-row justify-between h-auto text-[0.625rem] text-slate-500 dark:text-violet-200 leading-[0.625rem]">
            <span className="flex flex-row gap-2 text-nowrap">
              {countStudio}
              <svg
          ...
          <div className="mt-8 divide-y-2 divide-slate-200 text-slate-500 text-xs">
            <div className="flex flex-row-reverse justify-between mb-5 dark:text-violet-200">
              ...
              <div className="flex gap-2">
                <span className="flex flex-row justify-center items-center gap-2 bg-slate-200 dark:bg-violet-500 rounded-[0.3125rem] w-[3.125rem] h-[1.625rem] cursor-pointer">
                  {like}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
